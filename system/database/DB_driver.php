...
class CI_DB_driver {
    ...
    $send_error_at_email= config_item('send_error_at_email');
    if ( !empty( $send_error_at_email ) ) {
      $Subject= 'Error at ' . strftime('%Y-%m-%d %H:%M:%S')."\r";// severity : " . $severity."\r   message : " . $message."\r filepath : " . $filepath . "\r line : " . $line;
      foreach ( $message as $message_text) {
      ...
      return mail( $send_error_at_email, "Error at '" . config_item('base_url') . "' site", $Subject, $headers);
    } */
