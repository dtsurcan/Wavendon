(function($) {
    jQuery.fn.pictureMenu = function(options) {
        var defaults = {
            ...
            menuHeight: 100,              // The height of the menu (usually the same as the height of the images)
            menuWidth: 40,                // The length of a menu item (useMenuWidth must be true)
            ...
            fillColor: "#F5F4F4",            // Color of the menu
        ...
        return this.each(function() {
            ...
            listWidth = hoverWidth - o.menuWidth - 5;
